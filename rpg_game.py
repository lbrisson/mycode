...
bestiary = [{'name' : 'goblin', 'health' : 10, 'damage' : '1d5'},
            ...
            {'name': 'dragon', 'health': '40', 'damage' : '1d20'},
...
rooms = {
        ...
        'SECRET DOOR' : {
            'south' : 'LADDER',
            'randenc' : 'You have found the secret door which what lives behind it is unknown. It could be freedom or it could be despair. If you choose to proceed is your decision',
            'item' : 'cookie'
            }
        'LADDER' : {
